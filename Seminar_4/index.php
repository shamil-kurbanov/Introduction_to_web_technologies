<?php
$name = "Shamil Kurbanov";
$beruf = "Developer";
$city = "Dresden";
$country = "Germany";
$email = "kurbanov@outlook.de";
$phone = "123456789";
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-third">
            ...
            <div class="w3-white w3-text-grey w3-card-4">
                ...
                <div class="w3-container">
                    <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $beruf ?></p>
        ...
        <div class="w3-twothird">
            ...
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                <?php foreach ($experience as $key => $experienceN): ?>

                <div class="w3-container">
                    <h5 class="w3-opacity"><b><?=$experienceN['name']?> / <?=$experienceN['company']?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$experienceN['start']?> - <span class="w3-tag w3-teal w3-round"><?=$experienceN['end']?></span></h6>
